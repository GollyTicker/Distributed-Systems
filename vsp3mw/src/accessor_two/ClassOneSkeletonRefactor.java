 ...
 */
public class ClassOneSkeletonRefactor extends Skeleton<ClassOneImplBase> {
    ...
    */
    ...
    public ClassOneSkeletonRefactor(int port, ClassOneImplBase cls) throws IOException {
        super(port,cls);
    }
